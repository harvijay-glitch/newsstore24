function Contact() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-14">
      ...
      <h1 className="mt-3 text-4xl font-black">Contact AI News</h1>
      <div className="mt-8 space-y-5 text-lg leading-8 text-slate-600">
        <p>For corrections, source concerns, editorial feedback, or partnership enquiries, contact the AI News editorial team.</p>
